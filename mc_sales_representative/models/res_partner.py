...
class Partner(models.Model):
    ...
    sales_representative_id = fields.Many2one('res.partner', string='Sales Representative', domain=[('is_company', '=', True), '|', ('is_sales_representative', '=', True), ('type', '=', 'contact'), ('is_sales_representative', '=', True)])
