...
product_attributes_domain = {
    ...
    '[Seats] Colour of the foots': {'beech': ['|', '|', ('name', 'ilike', 'BEECH%'), ('name', '=', 'None'), ('name', '=', 'To Be Defined')],
                                    'metal': ['|', '|', ('name', 'ilike', 'METAL%'), ('name', '=', 'None'), ('name', '=', 'To Be Defined')],
                                    'oak': ['|', '|', ('name', 'ilike', 'OAK%'), ('name', '=', 'None'), ('name', '=', 'To Be Defined')],
                                    'walnut': ['|', '|', ('name', 'ilike', 'WALNUT%'), ('name', '=', 'None'), ('name', '=', 'To Be Defined')],
