...
class StockMove(models.Model):
    ...
    def _compute_sales_lot_id(self):
        """ Compute M2o relationship to Stock Production Manufacturing Numbers.
            There are 2 possible cases:
                - a stock move may have a relationship to a sale order line with Manufacturing Number, then retrieve it
